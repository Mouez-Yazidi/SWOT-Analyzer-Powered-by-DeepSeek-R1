...
def main():
    ...
    st.sidebar.image("https://cdn-icons-png.flaticon.com/512/3997/3997551.png")
    ...
    st.markdown("## 🚀 Elevate Your Career with **DeepSeek R1** : Unlock Your True Potential Today! 💼✨")
